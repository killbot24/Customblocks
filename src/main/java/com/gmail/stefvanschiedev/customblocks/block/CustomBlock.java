...
@SuppressWarnings("deprecated")
	...
	public void move(Location loc) {
		...
		armorStands[0].teleport(loc.clone().add(-.25, 0, -.25));
		armorStands[1].teleport(loc.clone().add(.25, 0, -.25));
		armorStands[2].teleport(loc.clone().add(.25, 0, .25));
		armorStands[3].teleport(loc.clone().add(-.25, 0, .25));
		armorStands[4].teleport(loc.clone().add(-.25, .5, -.25));
		armorStands[5].teleport(loc.clone().add(.25, .5, -.25));
		armorStands[6].teleport(loc.clone().add(.25, .5, .25));
		armorStands[7].teleport(loc.clone().add(-.25, .5, .25));
	}
